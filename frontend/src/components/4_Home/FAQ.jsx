...
const FAQ_ITEMS = [
  {
    ...
    answer:
      '회원가입부터 가볍게 시작하면 돼요. 메이트를 먼저 둘러보고, 마음에 맞는 분위기를 찾은 뒤 대화를 시작하면 훨씬 편하게 느껴질 수 있어요.',
  },
  {
    id: 2,
    category: 'guide',
  ...
  },
  {
    ...
    answer:
      '네. 긴 설명 없이도 부담 없이 시작할 수 있도록 회원가입 → 로그인 → 채팅 시작 흐름이 자연스럽게 이어지도록 구성했어요.',
  },
  {
    id: 4,
    category: 'account',
    ...
    answer:
      '헤더의 회원가입 버튼으로 이동해서 가입할 수 있어요. 가입 후 로그인하면 채팅과 마이페이지를 더 자연스럽게 이용할 수 있어요.',
  },
  {
    id: 5,
    category: 'account',
  ...
  },
  {
    ...
    answer:
      '현재 메인 흐름에서는 비회원에게 회원가입을 먼저 안내하고, 로그인 후 채팅으로 이어지는 구성이에요.',
  },
  {
    id: 9,
    category: 'chat',
