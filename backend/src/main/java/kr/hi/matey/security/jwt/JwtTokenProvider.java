...
public class JwtTokenProvider {
	...
	private String createToken(CustomUser user, long validity, boolean isRefresh) {
		...
		var builder = Jwts.builder().setSubject(user.getUsername()) // 토큰 소유자
